...
SET @sql =	'bcp   "SELECT CAST ((SELECT * from finzvit.dbo.View_3 order by 1 OFFSET ' + CONVERT(varchar(10), @Skip) + ' ROWS FETCH NEXT ' +  CONVERT(varchar(10), @Fetch) + ' ROWS ONLY FOR JSON PATH) AS VARCHAR(MAX)) AS json" ' +
